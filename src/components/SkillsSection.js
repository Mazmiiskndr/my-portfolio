                  ...
                  <div className="text">
                    <div>
                      <p>
                        ...
                        e-commerce and web projects, providing robust, scalable
                        solutions that ensure efficiency and adaptability to
                  ...
                  <div className="text">
                    <div>
                      <p>
                        ...
                        multiple projects, including React, InertiaJS and VueJS.
                      </p>
                    </div>
                  </div>
                  <div className="dots">
